 ...
 */
public class ModificarVuelos extends javax.swing.JFrame {
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarVuelos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarVuelos().setVisible(true);
    ...
    public void ModificarFormulario(int nBoton){
        botonSeleccionado = nBoton;
        
        
        if(botonSeleccionado == 1 && !jButton1.getBackground().equals(red)){
            JOptionPane.showMessageDialog(null, "No puedes MODIFICAR un asiento que NO esta reservado");
        }
            ...
            dispose();
            FormularioModificar fm = new FormularioModificar();
            fm.mostrar(botonSeleccionado);
            fm.setVisible(true);  
        }
