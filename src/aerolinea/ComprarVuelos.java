 ...
 */
public class ComprarVuelos extends javax.swing.JFrame {
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComprarVuelos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ComprarVuelos().setVisible(true);
    ...
    public void abrirFormulario(int nBoton){
        botonSeleccionado = nBoton;
        System.out.println(nBoton);
        
        if(botonSeleccionado == 1 && jButton1.getBackground().equals(red)){
            JOptionPane.showMessageDialog(null, "No puedes reservar un asiento que ya esta reservado");
        }
